...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="page-hero bg-image overlay-dark" style="background-image: url('{{asset('template')}}/dist/img/tabelkeluar.jpg'); height: 180px; width:100%;">
                  ...
                  <tr>
                    ...
                    <?php 
                      if(!empty($surat->seksi) || $surat->arsip == 'Diarsipkan'){
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif" class="btn btn-success disabled">Verifikasi</a><?php
                      }else if(!empty($surat->seksi) && $surat->arsip == 'Tidak Diarsipkan'){
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif" class="btn btn-success disabled">Verifikasi</a><?php
                      }else{
                        ?> <a href="data-surat/{{ $surat->id }}/verifikasi" id="verif" class="btn btn-success">Verifikasi</a><?php
                      }
                    ?>
                    <a href="data-surat/{{ $surat->id }}/edit" class="btn btn-primary d-inline ml-3">Edit</a>
